...
public class QuestRepository {
    ...
    public QuestRepository() {
        questions.add(new Question(0, "Ты потерял память. Принять вызов НЛО?"));
        questions.get(0).setAnswer(new Answer("Принять вызов.", 1));
        questions.get(0).setAnswer(new Answer("Отклонить вызов.", 4));

        questions.add(new Question(1, "Ты принял вызов. Поднимешься на мостик к капитану?"));
        ...
        questions.add(new Question(2, "Ты поднялся на мостик. Ты кто?"));
        questions.get(2).setAnswer(new Answer("Рассказать правду о себе", 3));
        questions.get(2).setAnswer(new Answer("Солгать о себе", 6));

        questions.add(new Question(3, "Тебя вернули домой. Победа!"));

        questions.add(new Question(4, "Ты отклонил вызов. Поражение!"));
        questions.add(new Question(5, "Ты не пошёл на переговоры. Поражение!"));
        questions.add(new Question(6, "Твою ложь разоблачили. Поражение!"));
    }
